...
Correlation studies are performed over global outputs, using the temperature-based detrended $R_0$ data as in the previous analysis over the different seasons. A total of 9 temperature-based climate variability indices have been used for the correlation analysis, which have been computed using the detrended temperature data utilized in the previous analysis. Their periodicity and pattern type, as well as area of influence, is summarized and represented in Table \ref{tab:climate-variability-indices} and Figure \ref{fig:climate-variability-indices}.
